...
/**
 * This class tries to provide an interactive console for developers on the CLI. 
...
abstract class WizConsole {
    ...
    /**
     * First method called during initialization
     *
     * @return void
     */
    abstract function interact() : void;
    ...
    public static function handleCliExceptions(?Exception $e = null) {
