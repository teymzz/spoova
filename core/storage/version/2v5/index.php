  ...
  Form::castError('login');
    ...
    Form::onpost(function() {
        ...
        echo "This is a post request";
                                ...
                                <div class="foot-note pxs-10">
                                    This function can also be used along with request submission buttons. For example, assuming we have a 
                                    request button with the name <span class="c-soft-pink">"login"</span>, we can ensure that a post callback is called only when that 
                                    submit button is clicked. The example is shown below: 
                                </div>
                                <div class="pxs-10">
                                    <div class="pre-area">
                                        <pre class="pre-code">
    Form::onpost('login', function() {
        ...
        echo "This is a post request with request key 'login' ";
                                ...
                                <div class="foot-note pxv-10 pvt-1">
                                    In the sample above, the <code>Form::onpost()</code> will look for a request key <span class="c-soft-pink">"login"</span> 
