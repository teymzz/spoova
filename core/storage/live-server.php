                    ...
                    <ul class="list-free pxs-1">
                        ...
                        <li>
                           ...
                           <br><br>
                            ...
                            <span class="c-olive fb-6">4.</span> By including the <code class="font-em-d8">&#64;live()</code> directive in template engines <br><br>
                        ...
                        <li> 
                            ...
                            1. Turn on.<br>
                            By including the <code class="font-em-d8">&lt;?= Res::watch() ?&gt;</code> in the head tag of your html code 
                            <br><br>
    
                            2. Turn off.<br>
                            By including the <code class="font-em-d8">&lt;?= Res::off() ?&gt;</code>  in the head tag of your html code
                            <br><br>
