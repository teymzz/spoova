...
<div class="pxv-10 bc-silver">File 1 - Frame file sample (UserFrame.php)</div>        
  ...
  ?&gt;
                        ...
                        <div class="box-full  font-em-d85 bc-white-dd shadow flow-x">
  <div class="pxv-10 bc-silver">File 2 - Windows file sample (Home.php)</div>        
                    <pre class="pre-code">
  &lt;?php
  ...
  ?&gt;
                        ...
                        <div class="font-em-d87">
                            <div class="">
                                Notice : In the above, we can discover that Frames are extensions of Windows.
  ...
  ?&gt;
                        ...
                        <div class="foot-note">
                            ...
                            <ol class="font-em-d9 mvt-10">
                                ...
                                <li>
                                    The <code>self::load()</code> is equivalent to <code>Res::load()</code> compiler method which loads the 
                                    <code>index.rex.php</code> template file from the <code>windows/Rex</code> directory
                                </li>
                            </ol>
