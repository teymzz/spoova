 ...
 <br>
                    ...
                    <div class="db-connection">
                        <div class="">
                            ...
                            Generally, port routing is done by the use of php inbuilt server to route urls. However, even when the method 
                            is applicable within the framework and has also been integrated with the (wvm or wmv) structure, the process can be slow and sometimes may prevent some files such as external library icons 
                    ...
                    <div>
                        <div class="fb-6 bc-white-dd box-full rad-4 pxv-8">
                         Using Ports
                        </div>    
                    </div>
                    ...
                    <div>
                        ...
                        <div class="port-routing mvt-6">
                            <div class="font-em-1">
                                ...
                                Once the server is started, the index server file will route urls using any of the 3 logics supported by this framework for loading 
                                routes.
                            </div> <br>
                            
                            
                            <div class="bc-white-dd font-em-d85">
  ...
  ?&gt;
                    ...
                    <div class="foot-note">
                        ...
                        <div>
                            <p>
                                Once the server is started, spoova begins to search for its route files within the <code>windows/Routes</code> directory. For more information on WVM approach visit <a href="<?= Rexit::domurl('docs/routings/wmv') ?>" class="c-olive rule-dotted">here</a>   <br> 
                            </p>
