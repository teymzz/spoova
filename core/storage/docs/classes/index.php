            ...
            <div class="">
              ...
              <div class="">
                ...
                <ul class="c-sea-green">
                  <li> <a href="<?= Rexit::route('::meta') ?>"> Meta </a> </li>
                  <li> <a href="<?= Rexit::route('::ajax') ?>"> Ajax </a> </li>
                  <li> <a href="<?= Rexit::route('::input') ?>"> Input </a> </li>
                  <li> <a href="<?= Rexit::route('::fileuploader') ?>"> FileUploader </a> </li>
                  <li> <a href="<?= Rexit::route('::imageclass') ?>"> ImageClass </a> </li>
                  <li> <a href="<?= Rexit::route('::filemanager') ?>"> FileManager </a> </li>
                  <li> <a href="<?= Rexit::route('::jwstoken') ?>"> JWSToken </a> </li>
                  <li> <a href="<?= Rexit::route('::jsonfy') ?>"> Jsonfy </a> </li>
                  <li> <a href="<?= Rexit::route('::hasher') ?>"> Hasher </a> </li>
                  <li> <a href="<?= Rexit::route('::notice') ?>"> Notice </a> </li>
                  <li> <a href="<?= Rexit::route('::forms') ?>"> Form </a> </li>
                  <li> <a href="<?= Rexit::route('::url') ?>"> Url </a> </li>
                  <li> <a href="<?= Rexit::route('::urlmapper') ?>"> UrlMapper </a> </li>
                  <li> <a href="<?= Rexit::route('::cli') ?>"> Cli </a> </li>
                  <li> <a href="<?= Rexit::route('::benchmark') ?>"> Benchmark </a> </li>
                </ul>
