...
@media screen and (max-width:1000px) {
    ...
    <div class="padd-x-4">
        ...
        <span class="font-em-d85">
            ...
            <table class="calibri" style="color:var(--orange-dd)">
                <tr class="" style="color:var(--olive)"> <th>Class</th> <th> <500px </th><th>>=500px</th><th>>=800px</th><th>>=950px</th><th>>=1025px</th></tr>
