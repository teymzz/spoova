...
@media screen and (max-width:1000px) {
    ...
    <div class="padd-x-4"> <br>
        ...
        <div class="font-em-d85">
            <div class="wid-fit c-olive font-em-1d5">Background Images sizing</div>
            There classes <code>b-cover</code>, <code>b-contain</code> are used to set image background-size 
