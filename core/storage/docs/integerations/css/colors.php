...
<html>
    ...
    <head>
        ...
        <title>Css Integerations - Colors</title>
...
body.--theme-dark{
    ...
    <script src='http://localhost/spoova/res/main/js/timeToggle.js'></script>
 ...
 <pre class="pre-code">
 <?php
 print to_lgts('<button class="in-flex-btn rad-r bc bc-purple bh-purple-dd oc-purple oc-1 oh-4 oo-5 ooh-7 c-white pxv-10 mxv-20" style="box-shadow: 0 0 0 10px rgb(var(--silver-d)), 0 0 0 14px purple;">
    Click me
 </button>');
 ?>
