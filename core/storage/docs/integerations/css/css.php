        ...
        <section class="tutorial">
            ...
            <div class="pxs-12"> <br>
                ...
                <span class="font-em-d9">
                    ...
                    <ul class="c-olive">
                        <li><a href="<?= Rexit::route('::display-properties') ?>">Display Classes</a></li>
                        <li><a href="<?= Rexit::route('::widths-and-heights') ?>">Width and Heights</a></li>
                        <li><a href="<?= Rexit::route('::responsive-paddings') ?>">Responsive paddings</a></li>
                        <li><a href="<?= Rexit::route('::margins') ?>">Setting Margins</a></li>
                        <li><a href="<?= Rexit::route('::fluid-boxes') ?>">Fluid Boxes</a></li>
                        <li><a href="<?= Rexit::route('::images-and-thumbnails') ?>">Images and Thumbails</a></li>
                        <li><a href="<?= Rexit::route('::overlay-items') ?>">Overlay items</a></li>
                        <li><a href="<?= Rexit::route('::overflow-items') ?>">Overflow items</a></li>
                        <li><a href="<?= Rexit::route('::text-alignments') ?>">Text Alignments</a></li>
                        <li><a href="<?= Rexit::route('::fonts') ?>">Fonts and Font Sizes</a></li>
                        <li><a href="<?= Rexit::route('::colors') ?>">Setting element Colors</a></li>
                        <li><a href="<?= Rexit::route('::property-inheritance') ?>">Property Inheritance</a></li>
                        <li><a href="<?= Rexit::route('::forms-and-alignment') ?>">Forms and Form Alignment</a></li>
                        <li><a href="<?= Rexit::route('::borders') ?>">Borders and Border Radius</a></li>
                        <li><a href="<?= Rexit::route('::menu-burger') ?>">Menu Burger</a></li>
                    </ul>
