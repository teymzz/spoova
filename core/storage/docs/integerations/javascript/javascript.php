    ...
    <section class="tutorial">
        ...
        <div class="pxs-12"> <br>
            ...
            <div class="flex-in midv font-em-2 bc-silver rad-4 calibri">
                <a href="<?= Rexit::domurl('docs/other-features/javascript') ?>"><div class="fb-6 pxs-20 c-grey bc-silver-d pxv-10 mxr-10">Js</div></a>
            ...
            <span class="font-em-d9">
                ...
                <ul class="mvt-6 c-olive">
                    <li>
                        <a href="<?= Rexit::route('::helper-functions') ?>">helper.js</a>
                    </li>
                    <li><a href="<?= Rexit::route('::loadFile') ?>.js">loadFile.js</a></li>
                    <li><a href="<?= Rexit::route('::formvalidator') ?>">formValidator.js</a></li>
                    <li><a href="<?= Rexit::route('::device') ?>.js">device.js</a></li>
                    <li><a href="<?= Rexit::route('::switcher') ?>.js">Switcher.js</a></li>
                    <li><a href="<?= Rexit::route('::intersect') ?>.js">Intersect.js</a></li>
                </ul> 
