...
<link rel="icon" href="http://localhost/trial/res/main/images/icons/favicon.png" />
        <title>Form Validator - Sample 12</title>
    ...
    <body>
        ...
        <div id="userscreen" data-height="full" data-form="validate" data-resp=".resp" class="grid-center bc-sky-blue-dd relative">
            ...
            <div class="sample1 bc-white-dd padd-4">
                ...
                <div class="font-em-d85 pxs-10"> <br> <b>Note that:</b>
                    <ol class="pxs-20">
                        <li>
            ...
            <div class="sample2 bc-white-dd pxv-4">
                ...
                <div class="font-em-d85 pxs-20"> <br> <b>Note that:</b>
                    <ol class="">
                        <li>
