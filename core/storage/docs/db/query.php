...
<head>
    ...
    <title>Tutorial - Database query</title>
...
window.onload = function() {
 ...
 <div class="font-menu pvs-4"> <a href="http://localhost/spoova/tutorial">Tutorial</a> <span class="bi-chevron-right"></span> <a href="http://localhost/spoova/tutorial/database">Database</a> <span class="bi-chevron-right"></span> <a href="http://localhost/spoova/tutorial/database/query">Query</a>  </div>

    <div class="font-em-1d5 c-orange">Database : Handling Queries</div> 
  ...
  if( $db->stateSet('state_name') ) {
      ...
      <span class="foot-note">
        <span class="head">Footnote:</span> stateSet is used to check if a state exists in storage. However, it can also be used
  ...
  if( $db->stateSet(':state_name') ) {
      ...
      <br><br>
      <div class="font-em-d9">Binded parameters can be updated when using a state set. <span class="c-orange-dd">For example:</span></div>
      <div class="box-full font-menu font-em-d85 bc-white-dd shadow flow-x">
