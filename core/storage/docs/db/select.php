...
window.onload = function() {
 ...
 <div class="font-menu pvs-4"> <a href="http://localhost/trial/tutorial">Tutorial</a> <span class="bi-chevron-right"></span> <a href="http://localhost/trial/tutorial/database">Database</a> <span class="bi-chevron-right"></span> <a href="http://localhost/trial/tutorial/database/select">Select</a>  </div>
