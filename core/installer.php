...
class install{
    ...
    private $userColumns = [
        ...
        'signup_date'=> ['len'=>'', 'type'=>'timestamp']
    ];
    ...
    function __construct(){
        $this->refreshBtn = '
          <form method="get" class="px-full fb-7 pxs-10 pvt-8">
            <button type="submit" class="btn bc-off-white bh-white-dd c-red-d ch-red-dd pull-right" name="refresh"> <span class="bi-bootstrap-reboot"></span></button> 
          </form>
        ';
        ...
        if(is_file(domroot().".htaccess")){
            ...
            if(isset($pathExp[1])){
                ...
                if($errDocText !== $matchesText){
                    print '
                    <div class="page-overlay ov-d5 grid-center c-silver font-em-1d5">
                            <span><span class="ico-spin ico-dotted-wheel mox"></span> Initializing...</span>
                    </div>';
                    ...
                    print "<script>setTimeout(()=>{window.location.reload()},1000)</script>"; 
                }             
            }
        }
    ...
    public function headerText($message = ''){
        ...
        $message = '
        <section class="intro pvs-10 deskmob-100 font-em-1d2 c-blue" style="width:55%">
         '.$message.'
        </section>
        ';
        ...
        if($this->install_status === 1){
            ...
            $this->headerText('
                ...
                <span class="font-em-d75 c-orange-dd">
                    (Note): A column of "id" will be automatically generated in your user table if it does not already exist. 
                    Alternatively, you will have to set up your users\' table manually in database along with the init file 
                    <span class="c-silver-dd">(icore/init)</span> 
                </span>'
            );
    ...
    private function dbConfig(){
        ...
        //configure default
        $fp = fopen(getDefined('_icore').'dbconfig.php', 'w');
        ...
        if($arg === 'refresh'){
           ...
           if(is_file(getDefined('_icore').'init')) unlink(getDefined('_icore').'init');
        } 
    ...
    private function dbForms(){
        ...
        $newDBOption = '
            <span>
                <span class="pxv-4 mox"><span><input type="checkbox" name="newdb"></span> Create new database
            </span>
        ';
        ...
        return (
            '
            <div class="dbset deskmob-100" style="width: 50%;">
                ...
                <form method="post" class="form-field in-flex-full f-col">
                    ...
                    <div role="group" class="i-flex-full bd rad-4 pxv-10">
                        <span>
                            <span class="pxv-4 mox"><span><input type="checkbox" name="dbcon_same"></span> Use '.(!online? "offline" : '').' settings for all
                        </span>
                        '.$newDBOption.'
                        <span hidden>
                            <span class="pxv-4 mox"><span><input type="checkbox" name="use_dbconfig" checked="checked"></span> install & use setup
                        </span>

                    </div> 
                    
                    <div class="i-flex" role="group">
                        <button class="flex-ico" style="min-width:100px;"><span class="bi-server mxr-4"></span> dbname</button> 
                        <input type="text" class="flex-full bd-r" name="dbname_off" placeholder="offline" value="'.$dbname_off.'" >
                    ...
                    <div class="i-flex" role="group">
                        ...
                        <input type="text" class="flex-full bd-r" name="dbuser_off" placeholder="offline" value="'.$dbuser_off.'" >
                    ...
                    <div class="i-flex" role="group">
                        ...
                        <input type="text" class="flex-full bd-r" name="dbpass_off" placeholder="offline" value="'.$dbpass_off.'" >
                    ...
                    <div class="i-flex" role="group">
                        ...
                        <input type="text" class="flex-full bd-r" name="dbserver_off" placeholder="offline" value="'.$dbserver_off.'"  >
                    ...
                    <div class="i-flex" role="group">
                        ...
                        <input type="text" class="flex-full bd-r" name="dbport_off" placeholder="offline" value="'.$dbport_off.'"  >
            ...
            if(!$tableConfig){
                ...
                <span class="pxs-10">
                  ...
                  <span class="mox">
                    ...
                    <span class="bold">Fix 2:</span> If you are unable to proceed after refresh, then delete the init file in root <span class="mox">[ icore ]</span> folder. Your page should detect the changes and fix the errors. <br>  
                  </span>
                </span>
                ';
                $this->fatal_error = 0;
            }elseif((int)$tableConfig !== 1){
                $this->message = "please configure your user with valid details!";
            }
            return false;       
        }
    ...
    private function userTableForms(){
        ...
        return ('
            <div class="users-table deskmob-100" style="width: 55%;">
                ...
                <form method="post" class="form-field in-flex-full f-col">
                    ...
                    <div class="in-flex bd-f rad-4 anc-btn-link bc bc-orange-dd bh-orange-d mid">
                        <button class="flex-btn pxv-14  c-white" name="populate"><span class="bi-ui-checks-grid"></span> Populate</button> 
                    </div>
                </form>        
            </div>
        ');
    ...
    private function showFields(){
        ...
        foreach($userColumns as $columnName => $columnProps){
            ...
            if(!in_array($fieldType, $categories)){
                $fields .= '
                <div role="group" class="i-flex-full midl mb-1 mt-2 bc-blue c-white">
                    <button class="flex-child mxs-10">'.$fieldType.' fields</button>
                </div> 
                ';
                $categories[] = $fieldType;
            }
            $fields .= '
                <div role="group" class="i-flex-full midl">
                    <input type="checkbox" class="flex-child mxs-10" id="'.$columnName.'" name="fields[]" value="'.$columnName.'"> 
                    <label class="bc-none wid-full no-select pxs-10" for="'.$columnName.'"> '.$columnName.' '.$length.$unique.'</label>
                </div>
            ';
        }
        ...
        if(!empty($fields)){
            $fields .= '
                <div role="group" class="i-flex-full midr">
                    <span class="flex-full"></span>
                    <span class="flex bc-white c-silver-dd mid">
                        <input type="checkbox" class="flex-child mxs-10" id="add_all" name="add_all"> 

                        <span class="no-wrap p6 pxl-1 pxr-10 ">ADD ALL</span>                    
                        <button class="no-wrap bc-blue c-white p6 flex-btn" name="complete">COMPLETE</button>                    
                    </span>
        ...
        print (
            '
            <div class="pxv-10 deskmob-100" style="width: 50%">
    ...
    private function resourceForm(){
        ...
        print (
            ...
            <form method="post" class="pxv-10 wid-full">
                <div class="resource-header bold pvs-10 font-em-1d2">Configure Resource Class</div>
                
                <div class="in-flex-full f-col wid-full pxv-4">
                    <div class="resource-watch">
                        <div class="font-em-d97 pvs-10">Enable Resource watch</div> 
                        <div role="group" class="i-flex-full">
                            <span class="flex bc-white c-silver-dd mid">
                                <input type="checkbox" class="flex-child mxs-10" id="watch_off" name="watch[offline]" value="offline" '.$offwatch.' checked> 
                    ...
                    <div class="resource-meta mvs-10">
