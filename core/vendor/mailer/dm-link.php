...
$html = '
  <setup type="config">
     @header        : {}  
     @site_name     : {}
     @site_mail     : {info@j.com} 
     @client_name   : {} 
     @client_mail   : {teymss@gmail.com} 
     @file          : {[user/var/res/myfile.jpg] [myfile.php]}
     @file          : {[myfile/var/filename.php] [a good file]}
  </setup>
    ...
    <body style="margin: 0; background-color:#fbfbfb; color: #9e9e9e; overflow-x:hidden; font-family: calibri;">
     <div style="width:100%; height: 100%; padding: 0; background-color:#fbfbfb;">
      ...
      <div class="content" style="display:inline-block; padding:20px; position: relative;">
        ...
        <p>
          Thanks for downloading our product. Your download link is ready   
        </p><br>

        <p> 
          Please click on the following link to get your product @ {{$link}}      
        </p><br>     
