...
namespace spoova\mi\core\classes\DB\DBM;
...
class MiSQL extends DBBridge{
  ...
  protected function open_connection() : bool {
    ...
    try{
      ...
      $this->isFailed = true;
      $this->conResponse = "connection failed (MySQL): no connection parameters defined!";  
      ...
      $this->dbConnection = false;      
      $this->isFailed = true;
      $this->conResponse = "connection failed (MySQL):".$e->getMessage();   
      return false;
    }
  ...
  public function process_query(string $sql) : bool{
  ...
  public function insert_query(array $sql) : bool{
  ...
  public function fetch_array(array $sql):array|false {
  ...
  public function update_query(array $sql) : bool {
  ...
  public function delete_query(array $sql) : bool{
  ...
  /**
   * Returns the value generated for an AUTOINCREMENT column by last query
   *
  ...
  public function buildBind(&$data, string $sqL) : bool{
