...
class MiPDO extends DBBridge {
  ...
  protected function open_connection() : bool {      
    ...
    try{ 
      ...
      if(!empty($configs)){
        ...
        $this->conResponse = "connection failed (PDO): no defined parameters";
      ...
      $this->dbConnection = false;
      $this->conResponse = "connection failed (PDO):".$e->getMessage();
   ...
   * Set insert query
   *
   * @param array $sql an array that contain sql and append keys.
   * @return boolean
   */
