...
abstract class SharedInfo{
  ...
  function __construct($conn = false, DBHandler $dbhandler = NULL){
    ...
    }elseif ((func_num_args() > 0) && ($conn !== false)) {
  ...
  /**
   * Returns the current handler if databse connection is successful 
   * This is the same as dbh
   *
   ...
   * @return void
   */
  public static function getDefined(string $core){
