...
final class Form extends FormField{
    ...
    //declare the highest level of call
    ...
    //close the highest level of call
    private static function end($close){
...
/* DOCUMENTATION
    ...
    Form::Group('div class="mox form-field pxv-20"', fn() =>
