...
class APILite {
   ...
   * @return APILite
   */
  public static function channel(string $type = API::NONE, ?Closure $test = null) : APILite {
   ...
   * check is done.
   *  - Default response code wmhen validation fails is 400
   * m
   * @return APILite
   */
  public static function isXMLHttpRequest(?Closure $callback = null) : APILite {
...
public static function isReferred(?Closure $callback = null){
   ...
   * @return APILite
   */
  public static function headers(array $list, ?Closure $callback = null) : APILite {
    if(!self::errorDebounce()){
   ...
   * Validation method to check for specified headers in ajax headers
   *
   * @param array $requests an array list of valid request methods
   ...
   * @return APILite
   */
  public static function accepts(array $requests, ?Closure $callback = null) : APILite {
    if(!self::errorDebounce()){
      if((self::$testid===false) || $callback){
   ...
   *
   * @param array $params an array list of valid url queries and their respective values
   *  - A false value will only check for the existence of the specified query name and not its value.
   *  - Default response code when validation fails is 405
   * 
   * @param Closure|null $callback when defined closure will always be triggered after
   * check is done.
   ...
   * @return APILite
   */
  public static function queries(array $params, ?Closure $callback = null) : APILite {
    if(!self::errorDebounce()){
      if((self::$testid===false) || $callback){
        $params = (array) $params;
   ...
   * @return APILite
   */
  public static function misses(array $source, array $data = []) : APILite {
   ...
   * @return APILite
   */
  public static function onfail(Closure|int $push) : APILite {
   ...
   * @return APILite
   */
  public static function json(bool $isJSON = true) : APILite {
  ...
  public static function spec() : APILite {
    self::$spec = true;
    return self::$API;
  }
