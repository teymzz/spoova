...
@template('template.t-tut')
  ...
  ?&gt;
                    ...
                    <div class="foot-note">
                        ...
                        <div>
                            <p>
                                Once the server is started, spoova begins to search for its route files within the <code>windows/Routes</code> directory. For more information on WVM approach visit <a href="@DomUrl('docs/routings/wmv')" class="c-olive rule-dotted">here</a>   <br> 
                            </p>
