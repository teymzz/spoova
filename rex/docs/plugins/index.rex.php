      ...
      <div class="pxv-20 c-black-ll">
        ...
        <div id="core" class="core-helpers"> 
            ...
            <div>
                ...
                located within the core folder itself away from the defualt folders or at the root of the application. The root 
                folder itself is named <code>spoova</code> . Therefore, namespaces follow the pattern of <code>spoova\</code> where 
