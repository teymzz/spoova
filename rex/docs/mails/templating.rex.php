@template('template.t-doc')
        ...
        <div class="pulling-data">
            ...
            <div class="">
              ...
              <div class="">
                  ...
                  <a href="@domurl('tutorial/mails/content')"><code>content</code></a> or the 
                  <a href="@domurl('tutorial/mails/content')">sendmail()</a> method. When handling template files, 
                      ...
                      <li>
                          Variables can be injected as local or global variables. Local variables are injected using the 
                            <code class="bg-primary c-white">
                              <a href="@domurl('tutorial/mails/inject')" class="i c-white">
  ...
  ?>
        ...
        <div class="font-menu pvs-6">
            ...
            parameters discussed in <a href="@domurl('tutorial/mails/setup')">setup</a>. However, 
