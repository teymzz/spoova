@template('template.t-doc')
        ...
        <div class="resource-intro">
            ...
            <div class="">
              ...
              <div class="">
                ...
                to public after updating the plugin. 
              </div> <br>
  ...
  &#60;?php
    ...
    <span class="c-sky-blue-dd">use spoova\core\classes\Mailer</span>
    ...
    if($mail->authorized()){
      ...
      $mailer->sendmail( Res::markup('mail-temp.feedback', fn() => compile()) );
          ...
          <p>
            ...
            You can learn more about this on the <a href="@Domurl('tutorial/mails/templating')">templating</a> page.
          </p>
          ...
          <div>
            ...
            <ul>
              <li> <a href="@domurl('tutorial/mails/server')"> server </a></li>
              <li> <a href="@domurl('tutorial/mails/setup')"> setup </a></li>
              <li> <a href="@domurl('tutorial/mails/content')"> content </a></li>
              <li> <a href="@domurl('tutorial/mails/sync')"> sync </a></li>
              <li> <a href="@domurl('tutorial/mails/inject')"> inject </a></li>
              <li> <a href="@domurl('tutorial/mails/authorize')"> authorize </a></li>
              <li> <a href="@domurl('tutorial/mails/authorized')"> authorized </a></li>
              <li> <a href="@domurl('tutorial/mails/pull')"> pull </a></li>
              <li> <a href="@domurl('tutorial/mails/info')"> info </a></li>
              <li> <a href="@domurl('tutorial/mails/attempted')"> attempted </a></li>
              <li> <a href="@domurl('tutorial/mails/casted')"> casted </a></li>
              <li> <a href="@domurl('tutorial/mails/sent')"> sent </a></li>
              <li> <a href="@domurl('tutorial/mails/response')"> response </a></li>
            </ul>
          </div>
      </div>
