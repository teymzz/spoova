   ...
   <div class="">
    ...
    <ul class="list-square">
      <li>
          ...
          <div class="">Example 1 : Handling connection errors </div>
    ...
    if( $db ) {
      ...
      <li>
          <div class="">Handling environment errors</div> <br>
          <div class="font-menu mvt-6">
              A database may be connected but no name (environment) selected. To work on a specific
          ...
          <div class="">Example 2 : Handling environment errors</div>
          <div class="mox-full font-menu  font-em-d85 bc-white-dd"> <br><br>
    <pre class="pre-code">
    $db = ($dbc = new DB)->openDB();
    ...
    if($dbc->active()) {
        ...
        <span class="comment">// outputs the current database selected </span>
        echo $dbc->currentDB();
      ...
      <li>
          Handling sql errors <br><br>
          <div class="font-menu">
              Sql errors are errors that occur after queries have been executed. To handle this errors, we 
              use the <code>error_exists()</code> and <code>error()</code> methods just as discussed earlier
          </div> <br>
          <div class="">Example 3 : Handling sql errors </div>
          <div class="mox-full font-menu  font-em-d85 bc-white-dd"> <br><br>
    <pre class="pre-code">
    $db = ($dbc = new DB)->openDB();
