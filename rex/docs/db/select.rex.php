   ...
   <div class="">
    ...
    <ul class="list-square">
      <li>
          ...
          select : The query method directive is the top level sql setter method for
          selecting data from database fields. It defines sql select queries that can be 
          executed later.

          <br><br>

          <div class="">Method 1 : select </div>
    ...
    $db->select('* from users');
          ...
          <div class="">Method 2 : select with chained controller </div>
          <div class="mox-full font-menu  font-em-d85 bc-white-dd"> <br><br>
    <pre class="pre-code">
