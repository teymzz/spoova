    ...
    <section class="pxv-20 database">
        <div class="">
            ...
            <li>
                ...
                do_update : The query method directive is the top level sql setter method for
                updating data in the database fields. It defines sql select queries that can be 
                executed later.

                <br><br>

                <div class="">Method 1 : Update </div>
                <div class="font-menu  font-em-d85 bc-white-dd flow-x"><br><br>
        <pre class="pre-code">
    $db->do_update('users')
