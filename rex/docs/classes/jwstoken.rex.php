      ...
      <div class="pxv-20 c-black-ll">
        ...
        <div class="helper-classes">
            ...
            <div class="">
                ...
                <ol>
                <li> <a href="#start"> set </a> </li>
                <li> <a href="#start"> algo </a> </li>
                <li> <a href="#filesize"> payload </a> </li>
                <li> <a href="#getfilename"> sign </a> </li>
                <li> <a href="#getfiletype"> expires </a> </li>
                <li> <a href="#getfilesize"> token </a> </li>
                <li> <a href="#getfiletemp"> decrypt </a> </li>
                <li> <a href="#getfileerror"> isValid </a> </li>
                <li> <a href="#getfiledata"> expired </a> </li>
                <li> <a href="#getfiledata"> pending </a> </li>
                <li> <a href="#uniquefile"> error </a> </li>
                </ol>
