@template('template.t-doc')
   ...
   <div class="pre-area"> <br><br>
    ...
    <span class="comment">//returns : site.com/user/profile</span>
    var_dump($stripped)
    </pre>
   ...
   <!-- code line ended -->
        ...
        <div class="font-menu">In the example above, by calculation, <code>limitText</code> automatically detects to add the letter <code>t</code> to the 
        <code>no</code> to form <code>not</code>  before adding ellipses.</div>
