 ...
 * @param timeout delay time before function is executed
 */
 function initFunc(callback, timeout) {
 ...
 * @param {*} callback callbasck function
 */
...
function dataScrollHash() {
    ...
    $("[data-scroll-hash]").on('click', function(e) {
        ...
        var scrollOffset = $("#" + point).offset().top;
