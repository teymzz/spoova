function loadFile(elem,parent,infopane){
  /*
    ...
    data-load   => (image, image-strict, size-strict, im-strict-sz) //for media autoload and restriction
  ...
  */
  ...
  if(elem != null && parent != null){
     ...
     inputFile.on('change',function(event){
      ...
      var fiOptions  = ['file','fi','file-strict','fi-strict','fisize-strict','fi-strict-sz']; //options disabled!
      
      //data settings      
      dataStrict = hasAttr(inputFile,'data-strict');
      dataSize   = !isNaN(inputFile.data('size'))? parseInt(inputFile.data('size')) : 300; //in kilobytes
