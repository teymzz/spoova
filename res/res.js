...
if(typeof Res == 'undefined'){
    ...
    class Res {
        ...
        getLocation(loc){
            ...
            uri.base = (loc == '')? 'index' : loc; 

            //if no address is found use index or current address
                        ...
                        if(status.isReady){
                            ...
                            if(status.isServerError){
                                ...
                                if(allowPop && mobi.serverError == 0) {
                                    ...
                                    rex.pop(rex.makeDiv(notice, cssText, 'spoova-notice-err'));
                                }
                            ...
                            //* Handle successful requests (200)
                                ...
                                if(!mobi.pause && stopped) setTimeout(() => rex.mobi.reload() , 200);
        ...
        sortErrors(content){
            ...
            for(let i = 0; i < phperrors.length; i++){
                ...
                if(matcherr1 != null && matcherr2 != null){
                    //error truly occurred prevent reload...
                    error = phperrors[i];
                    pause = true;
                    break;
                }
        ...
        status(request, content){
            ...
            if(content){
                if(content.includes('Parse Error') || content.includes('Parse error')){
